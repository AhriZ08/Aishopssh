...
@Controller
@Scope("prototype")
public class UserListAction extends ActionSupport implements ServletResponseAware, ServletRequestAware {
    ...
    public String GetAllUser(){
        request.getSession().setAttribute("users", manageService.GetAllUser());
        return "success";
    }
